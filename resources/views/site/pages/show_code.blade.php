        ...
        <div class="container">
            ...
            <div class="card bg-dark text-white p-3">
                <div class="col-md-12">
                    ...
                    <a href="#"
                        class="badge badge-secondary likebutton {{ $code->likes->where('user_id', Sentinel::getUser()->id)->first() ? 'clicked' : '' }}"
                        id="like{{ $code->id }}"><i
                            class="fa fa-thumbs-up"></i>&nbsp;<span>{{ $code->likes->count() }}</span></a>
                    <a href="#"
            ...
            <div class="card bg-dark text-white p-3">
                <div class="col-md-12">
                    ...
                    @include('site.pages.commentsDisplay', ['comments' => $code->comments()->paginate(2), 'code_id' =>
                    $code->id])
