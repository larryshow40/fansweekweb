        ...
        <div class="row">
            <div class="col-md-7 col-lg-8 sg-sticky">
                <div class="theiaStickySidebar">
                    ...
                    <div class="">
                        <form action="{{route('filter.predictions')}}" method="GET">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="custom-select mr-sm-2" name="federation" id="inlineFormCustomSelect">
                                        ...
                                        @foreach ($federations as $data)
                                            <option value="{{$data}}" {{($request->federation  == $data) ? 'selected' : ''}}>{{$data}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="date" value="{{$request->date }}" class="form-control text-white" name="date">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    @foreach ($markets as $data)
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="{{$data}}" value="{{$data}}" name="market" class="custom-control-input" {{($request->market  == $data) ? 'checked' : ''}}>
